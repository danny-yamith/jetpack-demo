...
import com.example.bixapp.users.albums.GalleryFragment;
import com.example.bixapp.users.posts.PostFragment;
    ...
    public Fragment getItem(int position) {
        switch (position) {
            case 0:
                ...
                return postFragment;
            case 1:
                GalleryFragment frgGallery = GalleryFragment.newInstance();
