...
import com.example.bixapp.users.posts.comments.DialogComments;
...
public class PostFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        rvPost.addItemDecoration(new LineItemDecoration(this.getActivity(), DividerItemDecoration.VERTICAL, 36));
        return view;
    }
